...
namespace Chip8
{
    public class Chip8System
    {
        ...
        /// </summary>
        private Timer clock_timers;

        /// <summary>
        /// Timer to simulate the clock of the CPU
        /// </summary>
        private Timer clock_cpu;

        /// <summary>
        /// HZ with the max frequency of the clock
        /// </summary>
        private uint clock_cpu_hz = Chip8System.CLOCK_CPU_FREQ;
        ...
        public void Reset() {
            ...
            this.timer_delay = 0;
            this.timer_sound = 0;
            this.clock_cpu_hz = (this.clock_cpu > 0) ? this.clock_cpu : Chip8System.CLOCK_CPU_FREQ;
                    ...
                    if (codefmask == 0x0000)
                    {
                        switch (this.opcode)
                        {
                            ...
                            case 0x00E0:
                                ...
                                // SHOT EVENT DISPLAY
                                this.pc += 2;
                        Console.WriteLine("OPCode conocido: " + this.opcode.ToString("X4"));
                                break;
        ...
        public static Chip8System LoadROM(String path)
        {
            Chip8System toret = new Chip8System();
            return Chip8System.LoadROM(File.ReadAllBytes(path));
        }

        public static Chip8System LoadROM(byte[] rom)
        {
            Chip8System toret = new Chip8System();
